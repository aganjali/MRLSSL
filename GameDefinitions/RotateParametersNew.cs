...
{
    public class RotateParametersNew
    {
        ...
        {
            string fileName = "RotateParametersNew.xml";
        ...
        {
            RotateParametersNew.VyValues[0] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[1] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[2] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[3] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[4] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[5] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[6] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[7] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[8] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[9] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[10] = new Dictionary<int, double>();
            RotateParametersNew.VyValues[11] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[0] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[1] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[2] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[3] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[4] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[5] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[6] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[7] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[8] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[9] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[10] = new Dictionary<int, double>();
            RotateParametersNew.OmegaValues[11] = new Dictionary<int, double>();
            if (!fileName.Contains(".xml"))
                fileName += ".xml";
        ...
        {
            RotateParametersNew.TuneFlag = true;
        }
