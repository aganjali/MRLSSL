    ...
    public class AttackerRole2017 : RoleBase
    {
        ...
        public override void DetermineNextState(GameStrategyEngine engine, WorldModel Model, int RobotID, Dictionary<int, RoleBase> AssignedRoles)
        {
            ...
            if (attackerPos.HasValue)
            {
                ...
                List<Planning.GamePlanner.Types.PassPointData> poses = engine.GameInfo.CalculateAttackerPassScore(Model, NormalSharedState.CommonInfo.ActiveID.Value, RobotID, topLeft, passSpeed, shootSpeed, width, heigth, Rows, column);
