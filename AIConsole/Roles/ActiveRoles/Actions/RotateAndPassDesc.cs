...
//namespace MRL.SSL.AIConsole.Roles.ActiveRoles.Actions
//{
//    class RotateAndPassDesc : ActionDescriptionBase
//    {
...
//                engine.GameInfo.CalculateKickSpeed(Model, RobotID, Model.BallState.Location, actInfo.PassTarget, actInfo.isChip, actInfo.pKind == NormalSharedState.ActivePassKind.OneTouch) :
//                Math.Max(0.6, 0.49 * Model.BallState.Location.DistanceFrom(actInfo.PassTarget));// *GamePlannerInfo.ChipCoef[RobotID];
...
//            }
//            //  return double.MaxValue;
//            if ((activeRoleState == NormalSharedState.ActiveRoleState.Conflict || activeRoleState == NormalSharedState.ActiveRoleState.LittleSpace) 
//                && (ActiveParameters.NewActiveParameters.playMode == ActiveParameters.NewActiveParameters.PlayMode.RotateAndPass) 
