...
{
    public class DefenderMarkerNormalRole1 : RoleBase, IMarkerDefender
    {
        ...
        public void Mark(GameStrategyEngine engine, WorldModel Model, int RobotID, Position2D target, double teta)
        {
            ...
            FreekickDefence.PreviousPositions[typeof(DefenderMarkerNormalRole1)] = pos;
        ...
        public override void DetermineNextState(GameStrategyEngine engine, GameDefinitions.WorldModel Model, int RobotID, Dictionary<int, RoleBase> AssignedRoles)
        {
            if (FreekickDefence.CurrentInfos.Any(a => a.RoleType == this.GetType()))
            {
                ...
                {
                    if (OurFreeKickMarkerUtils.PassedToOpponent(Model, RobotID, FreekickDefence.LastOppToMark1))
                    {
                ...
                {
                    if (!OurFreeKickMarkerUtils.PassedToOpponent(Model, RobotID, FreekickDefence.LastOppToMark1) || (FreekickDefence.LastOppToMark1.HasValue && lastopploc.DistanceFrom(Model.Opponents[FreekickDefence.LastOppToMark1.Value].Location) > 0.3))
                    {
