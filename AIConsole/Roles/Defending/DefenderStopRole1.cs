...
{
    public class DefenderStopRole1 : RoleBase
    {
        ...
        public SingleWirelessCommand PositioningStop(GameStrategyEngine engine, WorldModel Model, int RobotID, bool isChipKick, double kickPower)
        {
            ...
            SingleWirelessCommand SWC = GetSkill<GotoPointSkill>().GotoPoint(Model, RobotID, targ, teta, false, AvoidBall, StaticVariables.stopMaxSpeed, true);
            SWC.isChipKick = isChipKick;
            SWC.KickPower = kickPower;
            return SWC;
        }
        ...
        {
            return new List<RoleBase>() { new DefenderStopRole1() };
        }
