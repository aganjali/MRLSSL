...
namespace MRL.SSL.AIConsole.Roles
{
    public class GoalieCornerRole : RoleBase, IGoalie
    {
        ...
        public void Run(GameStrategyEngine engine, WorldModel Model, int RobotID, Position2D TargetPos, double Teta, DefenceInfo gol, Position2D DefencePos, int? cornerRole1ID, bool strategyGoalie)
        {
            ...
            //Position2D leftP = GameParameters.OurGoalLeft.Extend(0.1, 0), rightP = GameParameters.OurGoalRight.Extend(-0.1, 0);
            //Vector2D v1 = leftP - rightP;
            //Vector2D v2 = rightP - leftP;
            //DrawingObjects.AddObject(new StringDraw("leftP - rightP:" + v1.AngleInDegrees.ToString(), Position2D.Zero.Extend(1.1, 0)), "dsf35ds3a3a2s1d3s5csaz3czx");
            //DrawingObjects.AddObject(new StringDraw("rightP - leftP:" + v2.AngleInDegrees.ToString(), Position2D.Zero.Extend(1.2, 0)), "dfg3x21vd5safg3xv5z4xvwe");
            //DrawingObjects.AddObject(new StringDraw("ballspeedvec:" + Model.BallState.Speed.AngleInDegrees.ToString(), Position2D.Zero.Extend(1.3, 0)), "dsf35ds3a3a2s1d3s5csasad32z3czx");
