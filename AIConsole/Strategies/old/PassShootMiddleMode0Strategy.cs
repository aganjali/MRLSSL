...
{
    public class PassShootMiddleMode0Strategy : StrategyBase
    {
        ...
        {
            StrategyName = "PassShootMiddleMode0";
            AttendanceSize = 4;
            ...
            else if (CurrentState == (int)State.Go)
            {
                ...
                if (!passTargetCalculated)
                {
                    ...
                    else if (Mode == 2)
                    {
                        ...
                        PositionerPos1 = new Position2D(Model.BallState.Location.X - 0.5, 0);
                    }
                ...
                if (Mode == 0)
                {
                    ...
                    {
                        PositionerPos1 = new Position2D(Model.BallState.Location.X - .3, Model.BallState.Location.Y + (-1 * Math.Sign(Model.BallState.Location.Y) * .4));
                    }
                    double goodness;
