...
namespace MRL.SSL.AIConsole.Strategies.new_RC2017
{
    class _3inMiddle : StrategyBase
    {
        ...
        {
            StrategyName = "M_3inMiddle_Corner";
            AttendanceSize = 4;
            About = "3 robot in middle and A simple pass Shoot !!!";
        }
        ...
        public override void DetermineNextState(GameStrategyEngine engine, WorldModel Model)
        {
            ...
            if (CurrentState == (int)State.First)
            {
                ...
                ShooterFirstPos = new Position2D(-1.9, -sgn * 0.4);
                PoserPos1 = new Position2D(-1.9, -sgn * 0.7);
                PoserPos2 = new Position2D(-1.9, -sgn * 0.1);
            ...
            else if (CurrentState == (int)State.Go)
            {
                ...
                vec1 = (center - GameParameters.OppGoalCenter).GetNormalizeToCopy(1.4);
                ...
                PoserPos1 = new Position2D(-2.5, -sgn * 0.7);
                PoserPos2 = new Position2D(-2.5, -sgn * 0.1);
        ...
        public override Dictionary<int, RoleBase> RunStrategy(GameStrategyEngine engine, WorldModel Model, out Dictionary<int, CommonDelegate> Functions)
        {
            ...
            if (CurrentState == (int)State.First)
            {
                ...
                Planner.Add(PoserID1, PoserPos1, ShooterAngle, PathType.UnSafe, false, true, true, true, false);
                Planner.Add(PoserID2, PoserPos2, ShooterAngle, PathType.UnSafe, false, true, true, true, false);
