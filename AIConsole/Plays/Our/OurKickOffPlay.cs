...
{
    public class OurKickOffPlay : PlayBase
    {
        ...
        {
            if ((engine.EngineID == 0 && (Status == GameStatus.KickOff_OurTeam_Go || Status == GameStatus.KickOff_OurTeam_Waiting))
                || (engine.EngineID == 1 && (Status == GameStatus.KickOff_Opponent_Go || Status == GameStatus.KickOff_Opponent_Waiting)))
            {
